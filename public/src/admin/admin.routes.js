...
function config($stateProvider, $httpProvider) {
  ...
  $stateProvider
    ...
    .state('admin.auth.category.addcategory', {
      url: '/category/addcategory',
      templateUrl: 'src/admin/category/add-category.html',
      controller: 'AddCategoryController',
      controllerAs: 'addCategoryCtrl'
    })

    .state('admin.auth.category.additem', {
      url: "/additem",
      templateUrl: "src/admin/menu-item/menu-item-add.html",
      controller: 'MenuItemAddController',
      controllerAs: 'menuItemAddCtrl'
      // resolve: {
      // categoryId: ['categoryId', function (categoryId) {
      // return categoryId;
      // }]
      // }
    })
